...
namespace Richie.TowerDefence
{
    public class CameraController : MonoBehaviour
    {
        ...
        public static float _scrollSpeed = 5f;
        public static float ZoomModifier = 3f;
        ...
        public void Zoom()
        {
            ...
            transform.position += _scrollValue.y / ZoomModifier * _scrollSpeed * Time.deltaTime * _camera.forward;
        }
