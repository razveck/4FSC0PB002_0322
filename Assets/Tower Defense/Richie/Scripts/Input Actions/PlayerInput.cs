...
//     version 1.3.0
//     from Assets/Tower Defense/Richie/Scripts/Input Actions/PlayerInput.inputactions
//
...
namespace Richie
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""tab"",
                    ""type"": ""Button"",
                    ""id"": ""725701c6-82ab-47e7-a0d4-c01266b571ed"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""esc"",
                    ""type"": ""Button"",
                    ""id"": ""42726243-8fb3-453d-87ab-9b5d89ab688b"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6a29551d-5603-40f6-b1bd-893e64be9a13"",
                    ""path"": ""<Keyboard>/tab"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""9ffb951a-c2fb-4d5f-a339-8c22ef68a290"",
    ...
    ""controlSchemes"": []
            ...
            m_defence_tab = m_defence.FindAction("tab", throwIfNotFound: true);
            m_defence_esc = m_defence.FindAction("esc", throwIfNotFound: true);
            // player
        ...
        private readonly InputAction m_defence_tab;
        private readonly InputAction m_defence_esc;
        public struct DefenceActions
        {
            ...
            public InputAction @tab => m_Wrapper.m_defence_tab;
            public InputAction @esc => m_Wrapper.m_defence_esc;
            ...
            public void SetCallbacks(IDefenceActions instance)
            {
                if (m_Wrapper.m_DefenceActionsCallbackInterface != null)
                {
                    ...
                    @tab.started -= m_Wrapper.m_DefenceActionsCallbackInterface.OnTab;
                    @tab.performed -= m_Wrapper.m_DefenceActionsCallbackInterface.OnTab;
                    @tab.canceled -= m_Wrapper.m_DefenceActionsCallbackInterface.OnTab;
                    @esc.started -= m_Wrapper.m_DefenceActionsCallbackInterface.OnEsc;
                    @esc.performed -= m_Wrapper.m_DefenceActionsCallbackInterface.OnEsc;
                    @esc.canceled -= m_Wrapper.m_DefenceActionsCallbackInterface.OnEsc;
                }
